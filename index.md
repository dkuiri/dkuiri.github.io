...
<div style="display: flex; align-items: flex-start; gap: 30px; margin-bottom: 30px;">
  ...
  <div style="flex: 0 0 200px;">
    <img src="/assets/photo.jpg" alt="Dibyendu Kuiri" width="200" style="border-radius:10px;">
  </div>
  ...
  <div style="flex: 1;">
    ...
    <p>
      My research focuses on <strong>quantum transport</strong>,  
      <strong>superconductivity</strong>, and  
      <strong>topological phases of matter</strong> in hybrid nanostructures.
    </p>
